...
export const ConfigurationInstructions = () =>
    ...
    >
        ...
        <div>
            ...
            <ol>
                <li><Text display='inline' fontWeight={600}>Inventory Table</Text> - Contains your inventory of items that will be checked in/out.</li>
                <br/>
                <li><Text display='inline' fontWeight={600}>User Table</Text> - Contains the users that items will be checked out to.</li>
                <br/>
                <li>
